...
public class SportActivity extends Activity {
	...
	private ImageView legs_1;
	private ImageView leg_1;
	private TextView arms;
	private ImageView arm_1;
	private TextView abs;
	private ImageView abs1_2;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		_bg__sport = (View) findViewById(R.id._bg__sport);
		...
		legs_1 = (ImageView) findViewById(R.id.legs_1);
		leg_1 = (ImageView) findViewById(R.id.leg_1);
		arms = (TextView) findViewById(R.id.arms);
		arm_1 = (ImageView) findViewById(R.id.arm_1);
		abs = (TextView) findViewById(R.id.abs);
		abs1_2 = (ImageView) findViewById(R.id.abs1_2);
		full_body = (TextView) findViewById(R.id.full_body);
		...
		rectangle_40 = (View) findViewById(R.id.rectangle_30);
		sportg_3 = (ImageView) findViewById(R.id.sportg_3);
		sport_ek1 = (TextView) findViewById(R.id.sport_ek1);
